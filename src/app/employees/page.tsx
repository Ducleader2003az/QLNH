...
export default function EmployeesPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await api.delete(`/api/employees/${confirmDialog.empId}`)
  ...
  const saveTpl = (t: ShiftTemplate) => {
    ...
    toast.success('Đã lưu mẫu ca làm việc')
  }
    ...
    <AuthLayout>
      <div className="p-6 max-w-full">
        ...
        <ConfirmModal
          ...
          title={confirmDialog.empId ? 'Xác nhận xóa nhân viên' : 'Xác nhận xóa mẫu ca'}
