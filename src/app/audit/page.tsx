          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="relative w-full md:w-48">
              ...
              <select 
                ...
                className="w-full bg-gray-50 border-0 rounded-2xl pl-11 pr-6 py-4 outline-none focus:ring-2 focus:ring-blue-600 transition-all appearance-none font-medium cursor-pointer"
              >
                {['All', 'Order', 'Menu', 'Employee', 'Customer', 'Auth', 'Inventory'].map(m => (
